...
import {FormState} from '../../base/forms/types/FormState'
import {FieldSet} from '../../base/forms/types/FieldSet'
import {fieldDefaults} from '../../base/forms'
import mockAxios from 'jest-mock-axios'
import {createStore, IModuleStore} from 'redux-dynamic-modules'
import {ctxRender, rs} from './helpers'
import {CodeRunner} from './CodeRunner'
import {useForm} from '../index'
import {useLayoutEffect} from 'react'
import {defaultContextValues} from '../context'
import {nop} from '../../base/lib'

let store: IModuleStore<any>

export const fieldsFromObject = <T,>(x: T) => {
...
export function formState<T>(name = 'form.test', overrides?: Partial<FormState<any>> & {x?: T}) {
...
describe('Form module handling', () => {
  ...
  it('Creates a form module', async () => {
    await ctxRender(<CodeRunner code={makeForm}/>, {store})
  ...
  it('Generates fielders', async () => {
    ...
    await ctxRender(<CodeRunner code={fielderCheck}/>, {store})
  })
  it('Returns the same function across memoized calls', async () => {
    ...
    await ctxRender(<CodeRunner code={fielderValidate}/>, {store})
  })
  it('Stores and retrieves simple attributes', async () => {
    ...
    await ctxRender(<CodeRunner code={attributeVerification}/>, {store})
  })
  it('Handles added and removed fields', async () => {
    ...
    await ctxRender(<CodeRunner code={fieldManipulation}/>, {store})
  })
  it('Submits a form', async () => {
    ...
    await ctxRender(<CodeRunner code={submitForm}/>, {store})
  })
  it('Handles an error upon submission', async () => {
    ...
    await ctxRender(<CodeRunner code={failForm}/>, {store})
  })
  it('Sets and retrieves error-related properties', async () => {
    ...
    await ctxRender(<CodeRunner code={setErrors}/>, {store})
  })
  it('Resets a form', async () => {
    ...
    await ctxRender(<CodeRunner code={resetForm}/>, {store})
  })
  it('Clears errors', async () => {
    ...
    await ctxRender(<CodeRunner code={clearErrors}/>, {store})
  })
  it('Produces the resulting data', async () => {
    ...
    await ctxRender(<CodeRunner code={produceData}/>, {store})
  })
})
...
describe('Fielder functionality', () => {
  ...
  it('Complains about unregistered validators', async () => {
    ...
    await ctxRender(<CodeRunner code={fielderNoValidator}/>, {store})
  })
  ...
  it('Serializes a useful representation to JSON', async () => {
    ...
    await ctxRender(<CodeRunner code={jsonCheck}/>, {store})
  })
  it('Gets and sets the debounce setting', async () => {
    ...
    await ctxRender(<CodeRunner code={debounceSet}/>, {store})
  })
  it('Gets and sets the step', async () => {
    ...
    await ctxRender(<CodeRunner code={stepSet}/>, {store})
  })
  it('Gets and sets the disabled value', async () => {
    ...
    await ctxRender(<CodeRunner code={disabledSet}/>, {store})
  })
  it('Gets the field name', async () => {
    ...
    await ctxRender(<CodeRunner code={getName}/>, {store})
  })
  it('Handles cancelled validation', async () => {
    ...
    await ctxRender(<CodeRunner code={cancelValidation}/>, {store, context})
  })
  it('Resets to initial values', async () => {
    ...
    await ctxRender(<CodeRunner code={initialValues}/>, {store})
  })
})